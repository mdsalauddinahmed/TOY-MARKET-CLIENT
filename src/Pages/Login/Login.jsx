...
const handleLogInGoogle=()=>{
    ...
    return (
        ...
        <input type="submit"  value="Sign In" className='btn w-[8%] mx-auto bg-indigo-800 border-0  ' />
        ...
        <div className='w-[15%] mx-auto mb-12'>
         <button  onClick={handleLogInGoogle}  className='btn bg-indigo-800 border-0  '>Sign In by Google</button>
        </div>
